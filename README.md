...
上图展示的是摄像头画中画的成片效果关系：人像气泡可以显示在白板右下角、右上角、左下角或左上角；开启“摄像头合成进视频”后，导出的 MP4/WebM 里也会保留这个画中画层。示意图中的人像为公开文档用占位图，底图来自真实插件页面。
...
画中画效果见上方示意图：屏幕气泡负责讲解时预览，视频合成负责把人像真正写入导出的成片。
