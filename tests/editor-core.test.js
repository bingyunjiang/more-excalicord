...
edit.webcam.shape = "pill";
assert.strictEqual(core.createCompositionManifest(project).tracks.webcam.shape, "pill", "webcam shape must survive manifest creation");
edit.webcam.shape = "invalid";
assert.strictEqual(core.createCompositionManifest(project).tracks.webcam.shape, "rounded", "invalid webcam shape falls back safely");
